...
namespace Kpi.Service.Service.Auth
{
    public class AuthService : IAuthService
    {
        ...
        {
            var existUser = await _userRepository.GetAll(x => x.UserName == dto.UserName && x.Password.Equals(dto.Password.Encrypt()) && (x.Role == Domain.Enum.Role.Ceo || x.Role == Domain.Enum.Role.Director)).FirstOrDefaultAsync();
        ...
        {
            var existUser = await _userRepository.GetAll(x => x.UserName == dto.UserName && x.Password.Equals(dto.Password.Encrypt()) && (x.Role == Domain.Enum.Role.TeamMember || x.Role == Domain.Enum.Role.TeamLeader)).FirstOrDefaultAsync();
